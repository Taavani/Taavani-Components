...
export const ListWithOffers = {
  render: (args) => ({
    ...
    template:
      '<t-upsell-offer-list><t-upsell-loading></t-upsell-loading><t-upsell-loading></t-upsell-loading><t-upsell-loading></t-upsell-loading><!--<t-upsell-offer v-for="offer in args.offers" :offer="offer" :on-select="props => console.log(props)"></t-upsell-offer>--></t-upsell-offer-list>',
  }),
  args: {
    offers: data,
  },
