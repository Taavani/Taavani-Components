  ...
  <div class="relative lg:flex-1">
    <div class="flex justify-end items-center relative">
      <input id='departure-date'
             type="text"
             class="rounded-b-lg shadow-sm bg-white block w-full lg:rounded-lg border-t border-x-0 border-b-0 border-neutral-300 lg:border-white lg:border-0 p-0 pl-10 pr-3 py-2.5 text-gray-900 placeholder-gray-500 sm:text-sm focus:z-10 focus:ring-2 focus:ring-brand-blue focus:border-brand-blue"
             :value="departureDate"
             :disabled="disabled"
